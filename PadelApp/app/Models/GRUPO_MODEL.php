...
class GRUPO_MODEL{ 
    ...
    function DELETE1() {
		...
		if ( $result->num_rows == 1 ) {
			...
			$sql = "SELECT * FROM Enfrentamiento WHERE (IdCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
			$this->mysqli->query( $sql );
			
			if($result->num_rows >= 1){
				$sql = "DELETE FROM Enfrentamiento WHERE (IdCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
				$this->mysqli->query( $sql );
			}	
			
			$sql = "SELECT * FROM ELIMINATORIAS WHERE (IdCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
			$this->mysqli->query( $sql );
			
			if($result->num_rows >= 1){
				$sql = "DELETE FROM ELIMINATORIAS WHERE (IdCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
				$this->mysqli->query( $sql );
			}
			
			$sql = "SELECT * FROM usuarioparejas WHERE (Pareja_idCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
			$this->mysqli->query( $sql );
			
			if($result->num_rows >= 1){
				$sql = "DELETE FROM usuarioparejas WHERE (Pareja_idCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
				$this->mysqli->query( $sql );
			}
			
			$sql = "SELECT * FROM Pareja WHERE (idCampeonato = '$this->IdCampeonato', Tipo = '$this->Tipo', Nivel = '$this->Nivel',Letra = '$this->Letra')";
			$this->mysqli->query( $sql );
