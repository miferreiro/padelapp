...
if(!isset($_POST['login'])){//Si no se han recibido datos del login
	...
	$usuario = new USUARIO_MODEL($_REQUEST['login'],$_REQUEST['password'],$_REQUEST['Dni'],$_REQUEST['nombre'],$_REQUEST['apellidos'],$_REQUEST['telefono'],$_REQUEST['sexo'],'Deportista');//creamos un objeto del modelo USUARIO_MODEL donde le pasamos todos los datos del usuario registrado
