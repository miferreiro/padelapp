...
class CALENDARIO_EDIT {
	...
	function render( $valores ) {
		...
		<div class="seccion" align="center">
			...
			<form name="EDIT" action="../Controllers/CALENDARIO_CONTROLLER.php" method="post" enctype="multipart/form-data" />
				<div class="col-sm-4">
				<table class="table table-sm">
					...
					<tr>
						...
						<td class="formThTd"><input type="text" id="Resultado" name="Resultado" placeholder="<?php echo $strings['Escriba aqui...']?>" value="<?php echo $this->valores['Resultado']?>" maxlength="12" size="12" required  /> 
					</tr>
					<tr align="center">
						<td colspan="2">
