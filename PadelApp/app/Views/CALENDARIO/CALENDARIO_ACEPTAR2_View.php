...
?>
		<div class="seccion" align="center">
			<h2>
				<?php echo $strings['Tabla de confirmacion'];?>
			</h2>
			<div class="col-sm-4">
...
?>
			...
			<form action="../Controllers/CALENDARIO_CONTROLLER.php" method="post" style="display: inline" >
				...
				<button id ="buttonBien" type="submit" name="action" value="ACEPTAR2" ><img src="../Views/icon/accept_big.png" alt="<?php echo $strings['Confirmar'] ?>"/></button>
				<button id ="buttonBien" type="submit" name="action" value="DENEGAR2" ><img src="../Views/icon/cancel_big.png" alt="<?php echo $strings['Cancelar'] ?>"/></button>
			</form>
