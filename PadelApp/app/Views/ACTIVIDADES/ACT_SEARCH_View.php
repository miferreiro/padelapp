...
?>
		<div class="seccion" align="center">
			<h2>
				<?php echo $strings['Búsqueda de una clase'];?>
			</h2>
			<form name="ADD" action="../Controllers/ACT_CONTROLLER.php" method="post" enctype="multipart/form-data" onsubmit="">
			<div class="col-sm-4">
			<table class="table table-sm">
				<thead class="thead-light">
					...
					<tr>
						...
						<td class="formThTd"><input type="text" id="Actividad" name="Actividad" placeholder="<?php echo $strings['Escriba aqui...']?>" value="" maxlength="45" size="12"  />
					</tr>
