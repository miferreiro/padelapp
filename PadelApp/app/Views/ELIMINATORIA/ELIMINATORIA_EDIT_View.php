...
class ELIMINATORIA_EDIT {
	...
	function render( $valores ) {
		...
		<div class="seccion" align="center">
			...
			<form name="EDITAR" action="../Controllers/ELIMINATORIA_CONTROLLER.php" method="post" enctype="multipart/form-data" />
				<div class="col-sm-5">
			...
			<form action='../Controllers/ELIMINATORIA_CONTROLLER.php' style="display: inline">
